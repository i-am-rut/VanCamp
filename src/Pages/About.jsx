  ...
  return (
    <div className="about-page-container">
        ...
        <div className='about-page-content'>
            ...
            <p>Our mission is to enliven your road trip with the oerfect travel van rental. Our vans are recertified before each trip to ensure your travel plans can go off without a hitch. (Hitch costs extra 😉)</p>
